...
import {Modal,Image,ImageBackground,Text,View,StyleSheet,TouchableOpacity,ActivityIndicator,SafeAreaView,FlatList, Animated, ScrollView}from 'react-native';
...
const Update=(props)=>{
    ...
    return(
        ...
        <ImageBackground source={image}  style={styles.container} >
            ...
            resizeMode='center'
            style={styles.image}/>
        <Text style={styles.textTitle2}>Update Dish </Text>
